  ...
  add(target, options) {
    ...
    if (target) {
      ...
      let handleMousemove = (e) => {
        ...
        if (e.type === "touchmove") {
          x =
            e.touches[0].clientX + document.body.scrollLeft - target.startPos.x;
          y =
            e.touches[0].clientY + document.body.scrollTop - target.startPos.y;
        }
